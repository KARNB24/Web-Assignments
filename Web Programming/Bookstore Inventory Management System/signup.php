        ...
        <nav class="navbar navbar-inverse">
            <div class="container-fluid">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="login.php">View Product</a></li>
        ...
        <?php
                if(isset($_REQUEST['result']))
                {
                    if($_REQUEST['result']=="userexist")
                    {
                        ...
                        echo "&times;";
                        echo '</span>';
                        echo ' <strong>Fail!</strong> User Exists';
                        echo '</div>';
                    }
                    else if($_REQUEST['result']=="success")
                    {
                        ...
                        echo "&times;";
                        echo '</span>';
                        echo '<strong>Success!</strong> User Registered';
                        echo '</div>';
                    }
                    else if($_REQUEST['result']=="fail")
                    {
                        ...
                        echo "&times;";
                        echo '</span>';
                        echo ' <strong>Fail!</strong> User can not be registered';
                        echo '</div>';
